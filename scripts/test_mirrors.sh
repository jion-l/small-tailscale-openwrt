...
test_mirror() {
    ...
    local tailscale_url="${mirror}https://github.com/CH3NGYZ/ts-test/releases/latest/download/tailscaled_linux_amd64"
    local sha_url="${mirror}https://github.com/CH3NGYZ/ts-test/releases/latest/download/SHA256SUMS.txt"
